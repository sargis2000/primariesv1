...
LOGIN_REDIRECT_URL = '/'
VOTER_PROFILE_ACTIVATION_URL = 'http://127.0.0.1:8000/api-auth/activate-voter-profile/'
CANDIDATE_PROFILE_ACTIVATION_URL = 'http://127.0.0.1:8000/api-auth/activate-candidate-profile/'
