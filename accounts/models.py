...
class CandidateProfile(models.Model):
    ...
    party = models.CharField(max_length=200, help_text='Կուսակցություն', default='Անկուսակցական')
    picture = models.ImageField(upload_to='profile_pictures')
    email = models.EmailField()
    phone_number = PhoneNumberField()
    birthdate = models.DateField()
    address = models.CharField(max_length=50, verbose_name='Address')
    soc_url = models.URLField(max_length=300, verbose_name='URL', help_text='Social account url')
    gender = models.CharField(max_length=6, choices=gender)
    education = RichTextField(null=True, blank=True)
    about = RichTextField(help_text='here you can write about yourself', null=True, blank=True)
    marital_status = RichTextField(
        help_text='here you can  about candidate marital status',
        verbose_name='marital status',
        null=True, blank=True
    )
    work_experience = RichTextField(help_text='About work experience', verbose_name='work experience', null=True, blank=True)
    political_experience = RichTextField(help_text='About political experience', verbose_name='political experience',null=True, blank=True)
...
class CandidatePost(models.Model):
    ...
    text = RichTextField()
    media_path = models.URLField(max_length=300, verbose_name='media_URL', help_text='Social account url')
